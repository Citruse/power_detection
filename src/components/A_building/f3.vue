          ...
          <div class="body_1">
            <el-row class="btn_row" v-for="item in west_rooms" :key="item.id">
              <el-button
                ...
                @click="gerCurRoom(['西', 300 + item]), draws()"
                >西{{ 300 + item }}</el-button
              >
              <el-button
                class="floor_btn"
                type="primary"
                ...
                @click="gerCurRoom(['西', 301 + item]), draws()"
                >西{{ 301 + item }}</el-button
              >
            </el-row>
          </div>
          <div class="body_2">
            ...
            <div class="body_2_inner">
              <el-row class="btn_row" v-for="item in mid_rooms" :key="item.id">
                <el-button
                  ...
                  @click="gerCurRoom(['中', 300 + item]), draws()"
                  >中{{ 300 + item }}</el-button
                >
                <el-button
                  class="floor_btn"
                  type="primary"
                  ...
                  @click="gerCurRoom(['中', 301 + item]), draws()"
                  >中{{ 301 + item }}</el-button
                >
                <el-button
                  class="floor_btn"
                  type="primary"
                  ...
                  size="mini"
                  :disabled="mid_able[item+1]"
                  @click="gerCurRoom(['中', 302 + item]), draws()"
                  >中{{ 302 + item }}</el-button
                >
                <el-button
                  class="floor_btn"
                  type="primary"
                  ...
                  @click="gerCurRoom(['中', 303 + item]), draws()"
                  >中{{ 303 + item }}</el-button
                >
              </el-row>
            </div>
          </div>
          <div class="body_3">
            <el-row class="btn_row" v-for="item in east_rooms" :key="item.id">
              <el-button
                ...
                @click="gerCurRoom(['东', 300 + item]), draws()"
                >东{{ 300 + item }}</el-button
              >
              <el-button
                class="floor_btn"
                type="primary"
                ...
                @click="gerCurRoom(['东', 301 + item]), draws()"
                >东{{ 301 + item }}</el-button
              >
            </el-row>
          </div>
        </dv-border-box-3>
