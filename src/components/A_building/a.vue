<template>
  <div class="container">
    <div class="box_all">
      <div class="box_data" style="height:100%; width:100%">
        <dv-border-box-8 class="room_box">
          <div id="titles">
            <div class="l_title">
              <span style="font-size: 15px">实时数据</span>
            </div>
            <div class="l_title">
              <span style="font-size: 15px">历史数据</span>
            </div>
          </div>
          <div id="the_building">
            <div class="datas" id="building1">
            ...
            <div class="datas" id="building2">
              <div class="data_charts" id="chartHistory"></div>
            </div>
          </div>
          <span style="font-size: 10px"
                >单位：电流-A， 电压-V， 功率-KW</span
              >
        </dv-border-box-8>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    // 获取电力数据
    async getValue() {
      const { data: res } = await this.$http.get("/data/now", {
        params: this.getValueInof,
        headers: this.pushToken,
      });
      if (!res.success) {
